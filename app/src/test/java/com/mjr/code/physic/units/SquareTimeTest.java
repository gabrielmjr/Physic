...
public class SquareTimeTest {
	...
	public void toSquareMinuteFixedResultTest() throws PhysicException {
		...
		int squareWeekValue = 1;
		try {
			Time squareSecondTestResult = new Time("0.00027777777777777778", SQUARE_SECOND);
			Time squareMinuteTestResult = new Time("1.00000000000000000000", SQUARE_MINUTE);
			Time squareHourTestResult = new Time("3600.00000000000000000000", SQUARE_HOUR);
			Time squareDayTestResult = new Time("2073600.00000000000000000000", SQUARE_DAY);
			Time squareWeekTestResult = new Time("101606400.00000000000000000000", SQUARE_WEEK);
	...
	public void toSquareHourFixedResultTest() throws PhysicException {
		...
		int squareWeekValue = 1;
		try {
			Time squareSecondTestResult = new Time("0.00000007716049382716", SQUARE_SECOND);
			Time squareMinuteTestResult = new Time("0.00027777777777777778", SQUARE_MINUTE);
			Time squareHourTestResult = new Time("1.00000000000000000000", SQUARE_HOUR);
			Time squareDayTestResult = new Time("576.00000000000000000000", SQUARE_DAY);
			Time squareWeekTestResult = new Time("28224.00000000000000000000", SQUARE_WEEK);
	...
	public void toSquareDayFixedResultTest() throws PhysicException {
		...
		int squareWeekValue = 1;
		try {
			Time squareSecondTestResult = new Time("0.00000000013395919067", SQUARE_SECOND);
			Time squareMinuteTestResult = new Time("0.00000048225308641975", SQUARE_MINUTE);
			Time squareHourTestResult = new Time("0.00173611111111111111", SQUARE_HOUR);
			Time squareDayTestResult = new Time("1.00000000000000000000", SQUARE_DAY);
			Time squareWeekTestResult = new Time("49.00000000000000000000", SQUARE_WEEK);
