...
public class FluidFlow implements FluidFlowIF{
  ...
  public static final int getStep = 1;
  ...
  public String fFluidFlow(double volume, double time) {
    ...
    @Override
    public String tFluidFlow(double raio, double velocidade, int resultOrStep) {
    ...
    @Override
    public String sSpeed(double fluidFlow, double raio, int resultOrStep) {
    ...
    // Raio: r = √[Q / (π * v)]
    @Override
    public String ray(double fluidFlow, double velocidade, int resultOrStep) {
