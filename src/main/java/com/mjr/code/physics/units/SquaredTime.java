...
public class SquaredTime extends Unit implements ISquaredTime {
    ...
    protected static final BigDecimal[] SQUAREDD_TIME_SCALES = new BigDecimal[]
            {
                    TIME_SCALES[SQUARED_WEEK - UNIT_SCALE].pow(2),
                    TIME_SCALES[SQUARED_DAY - UNIT_SCALE].pow(2),
                    TIME_SCALES[SQUARED_HOUR - UNIT_SCALE].pow(2),
                    TIME_SCALES[SQUARED_MINUTE - UNIT_SCALE].pow(2),
                    TIME_SCALES[SQUARED_SECOND - UNIT_SCALE].pow(2)
            };

    public static final String SQUARED_WEEK_SYMBOL = WEEK_IN_YEAR_SYMBOL + "²";
    public static final String SQUARED_DAY_SYMBOL = DAY_SYMBOL + "²";
    public static final String SQUARED_HOUR_SYMBOL = HOUR_SYMBOL + "²";
    public static final String SQUARED_MINUTE_SYMBOL = MINUTE_SYMBOL + "²";
    public static final String SQUARED_SECOND_SYMBOL = SECOND_SYMBOL + "²";
    ...
    public static @NotNull SquaredTime toSquaredSecond(double value, int unit) {
        return new SquaredTime(divide(multiply(value, SQUAREDD_TIME_SCALES[SQUARED_SECOND - UNIT_SCALE]), SQUAREDD_TIME_SCALES[unit - UNIT_SCALE]), SQUARED_SECOND);
    }

    @Contract("_, _ -> new")
    public static @NotNull SquaredTime toSquaredMinute(double value, int unit) {
        return new SquaredTime(divide(multiply(value, SQUAREDD_TIME_SCALES[SQUARED_MINUTE - UNIT_SCALE]), SQUAREDD_TIME_SCALES[unit - UNIT_SCALE]), SQUARED_MINUTE);
    }

    @Contract("_, _ -> new")
    public static @NotNull SquaredTime toSquaredHour(double value, int unit) {
        return new SquaredTime(divide(multiply(value, SQUAREDD_TIME_SCALES[SQUARED_HOUR - UNIT_SCALE]), SQUAREDD_TIME_SCALES[unit - UNIT_SCALE]), SQUARED_HOUR);
    }

    @Contract("_, _ -> new")
    public static @NotNull SquaredTime toSquaredDay(double value, int unit) {
        return new SquaredTime(divide(multiply(value, SQUAREDD_TIME_SCALES[SQUARED_DAY - UNIT_SCALE]), SQUAREDD_TIME_SCALES[unit - UNIT_SCALE]), SQUARED_DAY);
    }

    @Contract("_, _ -> new")
    public static @NotNull SquaredTime toSquaredWeek(double value, int unit) {
        return new SquaredTime(divide(multiply(value, SQUAREDD_TIME_SCALES[SQUARED_WEEK - UNIT_SCALE]), SQUAREDD_TIME_SCALES[unit - UNIT_SCALE]), SQUARED_WEEK);
    }

    @Override
    public SquaredTime toSquaredSecond() {
        setUnit(SQUARED_SECOND - UNIT_SCALE);
        value = divide(multiply(value, SQUAREDD_TIME_SCALES[unit - UNIT_SCALE]), SQUAREDD_TIME_SCALES[SQUARED_SECOND - UNIT_SCALE]);
        return this;
    }
    ...
    public SquaredTime toSquaredMinute() {
        ...
        value = divide(multiply(value, SQUAREDD_TIME_SCALES[unit - UNIT_SCALE]), SQUAREDD_TIME_SCALES[SQUARED_MINUTE - UNIT_SCALE]);
        return this;
    }
    ...
    public SquaredTime toSquaredHour() {
        ...
        value = divide(multiply(value, SQUAREDD_TIME_SCALES[unit - UNIT_SCALE]), SQUAREDD_TIME_SCALES[SQUARED_HOUR - UNIT_SCALE]);
        return this;
    }
    ...
    public SquaredTime toSquaredDay() {
        ...
        value = divide(multiply(value, SQUAREDD_TIME_SCALES[unit - UNIT_SCALE]), SQUAREDD_TIME_SCALES[SQUARED_DAY - UNIT_SCALE]);
        return this;
    }
    ...
    public SquaredTime toSquaredWeek() {
        ...
        value = divide(multiply(value, SQUAREDD_TIME_SCALES[unit - UNIT_SCALE]), SQUAREDD_TIME_SCALES[SQUARED_WEEK - UNIT_SCALE]);
        return this;
    }
